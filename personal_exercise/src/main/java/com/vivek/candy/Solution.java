...
class Solution {
    ...
    private void updateCandies(int[] candies, int[] ratings) {
        for (int i = 0; i < ratings.length; i++) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("####Minimum candies needed for ratings1: " + solution.candy(ratings1)); // Output: 5
        System.out.println("####Minimum candies needed for ratings2: " + solution.candy(ratings2)); // Output: 4
        System.out.println("####Minimum candies needed for ratings3: " + solution.candy(ratings3)); // Output: 7
        System.out.println("####Minimum candies needed for ratings3: " + solution.candy(ratings4)); // Output: 7
    }
}
