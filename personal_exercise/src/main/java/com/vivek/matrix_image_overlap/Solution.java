package com.vivek.matrix_image_overlap;
...
public class Solution {
     ...
     */
     ...
     public int largestOverlap(int[][] img1, int[][] img2) {
        //option 1 brute force, make every possible translation and then count the numbner of overlaps

        //option 2, check how many 
        return 0;
     }

     private int countOverlap(int[][] first, int[][] second) {
        int count = 0;
